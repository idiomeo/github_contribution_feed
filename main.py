...
def main():
    ...
    user_name = ask("Git 用户名", default="idiomeo")
    user_email = ask("Git 邮箱", default="idiomeo@hotmail.com")
    start_year = ask("起始年份", cast=int)
    end_year = ask("结束年份", cast=int)

    if start_year > end_year:
        print("起始年份必须小于等于结束年份！")
        sys.exit(1)
    ...
    print("下一步：")
    print("  cd contribution_art")
    print("  git remote add origin <YOUR_URL>  # 若未添加")
